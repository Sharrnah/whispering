...
class Qwen3TTSTokenizerV2DecoderTransformerModel(Qwen3TTSTokenizerV2DecoderPreTrainedModel):
    ...
    # Transformers 5 replaced the deprecated check_model_inputs decorator with
    # merge_with_config_defaults. This runtime targets the project's 5.14.1
    # pin, and no generated API documentation is needed in the application.
