...
class SettingsManager:
    def __init__(self, immutable=False):
        ...
        self.translate_settings = {
            ...
            "tts_streamed_min_play_time": 0.3,  # minimum play-time of audio to prevent initial stuttering
    ...
    def get_available_setting_values(self):
        possible_settings = {
            ...
            #"tts_type": ["silero", "f5_e2", "zonos", "kokoro", "orpheus", "parler", ""],
            "tts_type": ["silero", "f5_e2", "zonos", "kokoro", "orpheus", "chatterbox", "maya1", ""],
